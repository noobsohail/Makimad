...
from Makima import BOT_USERNAME, dp
from Makima.config import get_bool_key
from Makima.modules.error import parse_update
from Makima.utils.filters import ALL_FILTERS
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("Makima.utils.filters." + module_name)
