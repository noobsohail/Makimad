...
async def select_lang_keyboard(message, strings, edit=False):
    ...
    markup.add(
        InlineKeyboardButton(
            strings["crowdin_btn"], url="Makima_Devil_Support"
        )
    )
    if edit:
...
__help__ = """
This module is dedicated towards utlising MakimaX's localization feature! You can also <a href='https://crowdin.com/project/Makimax'>contribute</a> for improving localization in MakimaX!
...
MakimaX will send you bunch of inline buttons where you can select your prefered language interatively without any hassles!
"""
