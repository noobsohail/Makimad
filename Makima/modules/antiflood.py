...
from Makima import dp
from Makima.decorator import register
from Makima.modules.utils.connections import chat_connection
from Makima.modules.utils.language import get_strings, get_strings_dec
from Makima.modules.utils.message import (
    InvalidTimeUnit,
    convert_time,
    get_args,
    need_args_dec,
)
from Makima.modules.utils.restrictions import ban_user, kick_user, mute_user
from Makima.modules.utils.user_details import get_user_link, is_user_admin
from Makima.services.mongo import db
from Makima.services.redis import bredis, redis
from Makima.utils.cached import cached
...
MakimaX: <code>Please send expiration time [...]</code>
