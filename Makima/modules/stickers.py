...
from Makima.services.events import register as MakimaX
...
async def _(event):
    ...
    packshortname = f"Makima_stickers_{userid}"
    kanga = await event.reply("Hello, This Sticker Looks Noice. Mind if MakimaX steal it")
    ...
    if is_a_s:
        ...
        packshortname = f"Makima_animated_{userid}"
