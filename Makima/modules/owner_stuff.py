...
from Makima import MakimaX_VERSION, OWNER_ID, bot, dp
from Makima.decorator import COMMANDS_ALIASES, REGISTRED_COMMANDS, register
from Makima.modules import LOADED_MODULES
from Makima.services.mongo import db, mongodb
from Makima.services.redis import redis
...
async def restart_bot(message):
    await message.reply("MakimaX will be restarted...")
    args = [sys.executable, "-m", "Makima"]
...
async def stats(message):
    if message.from_user.id == OWNER_ID:
        text = f"<b>MakimaX {MakimaX_VERSION} stats</b>\n"
