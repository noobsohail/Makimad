...
from Makima.config import get_bool_key, get_int_key, get_list_key, get_str_key
from Makima.services.telethon import tbot
from Makima.utils.logger import log
from Makima.versions import MakimaX_VERSION

log.info("----------------------")
log.info("|   Makima Devil     |")
log.info("----------------------")
log.info("Version: " + MakimaX_VERSION)

if get_bool_key("DEBUG_MODE") is True:
    MakimaX_VERSION += "-debug"
